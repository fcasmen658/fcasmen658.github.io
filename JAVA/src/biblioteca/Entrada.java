...
public class Entrada {
	...
	public static char caracter() {
        ...
        public static LocalDate leerFecha(String mensaje, boolean permitirVacio, LocalDate valorPorDefecto) {
                ...
                do {
                        ...
                        if (valor.isBlank()) {
                                if (permitirVacio) {
                                        fecha = valorPorDefecto;
                                        leido = true;
                                } else {
                                        System.out.print("ERROR: La fecha es obligatoria. Inténtalo de nuevo. ");
                                }
                        } else {
                                try {
                                        ...
                                        System.out.print("ERROR: Formato de fecha inválido (YYYY-MM-DD). Inténtalo de nuevo: ");
                                }
                        }
                } while (!leido);
                return fecha;
